    ...
    <div className="relative pt-24 font-tiro">
      ...
      {!hospitals || hospitals.length === 0 ? (
        <div className="flex justify-center items-center h-64">
          <div className="text-xl">No hospitals found</div>
        </div>
      ) : (
              ...
              return (
                ...
                >
                  <img
                    ...
                    src={image}
                    onError={(e) => {
                      e.target.src = HospitalIcon; // Fallback image
                    }}
                  />
                  <div>
                    ...
                    {/* Only show link if we have an ID */}
                    {linkId ? (
                      <Link to={`/হাসপাতাল/${linkId}`} state={hospital}>
